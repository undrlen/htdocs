		...
		public function config() {
			$params = [
				'config' => [
					...
					'bool:is_change_catalog_item_h1_from_cml' => null,
					'bool:is_change_catalog_item_title_from_cml' => null
				]
			];
			...
			if ($this->isSaveMode()) {
				...
				$module->setNeedToRestoreCatalogItemsFromTrashInCML($params['config']['bool:restore_deleted_catalog_items_from_cml']);
				$module->setChangeCatalogItemH1InCML($params['config']['bool:is_change_catalog_item_h1_from_cml']);
				$module->setChangeCatalogItemTitleInCML($params['config']['bool:is_change_catalog_item_title_from_cml']);
				$this->chooseRedirect();
			}

			$params['config']['bool:use_cml_trade_offers'] = (int) $module->isTradeOffersUsedInCMl();
			$params['config']['bool:restore_deleted_catalog_items_from_cml'] = (int) $module->isNeedToRestoreCatalogItemsFromTrashInCML();
			$params['config']['bool:is_change_catalog_item_h1_from_cml'] = (int) $module->isChangeCatalogItemH1InCML();
			$params['config']['bool:is_change_catalog_item_title_from_cml'] = (int) $module->isChangeCatalogItemTitleInCML();
